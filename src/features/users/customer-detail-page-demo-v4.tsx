...
export function CustomerDetailPageDemoV4() {
  ...
  return (
    <AppShell>
      <Alert className="border-amber-500/50">
        <InfoIcon />
        <AlertTitle>Демо вёрстки, вариант 4 — не финальная страница</AlertTitle>
        <AlertDescription>
          Копия варианта 3 с переставленными местами блоками «Членства в брендах» и «Устройства подключено» — членства теперь в верхнем ряду рядом с
          выручкой, а устройства — отдельным блоком на всю ширину ниже. Данные захардкожены, кнопки не работают.
        </AlertDescription>
      </Alert>
