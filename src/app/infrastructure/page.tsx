...
export default function InfrastructurePage() {
  ...
  const counters = [
    ...
    { label: "Healthy", value: summary.data?.healthy, icon: Activity },
    { label: "Unhealthy", value: summary.data?.unhealthy, icon: CircleAlert },
    { label: "Открытые incidents", value: summary.data?.openIncidents, icon: CircleAlert },
  ];

  return <AppShell>
    <PageHeader title="Инфраструктура" description="Read-only inventory и health-состояние из OpenAPI 0.6.0" />
